 ...
 * result that will be obtained by {@link #roll()}. Then, the next result reuses
 * these same numbers but rotating them by one position, the old result of the
 * first die becoming the result of the second die, the old result of the second
 * die becoming the result of the third die, and the old result of the third die
 * becoming the result of the first die.
 * <p>
